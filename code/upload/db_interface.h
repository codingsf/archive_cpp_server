...
public:
	...
	TLV_HANDLE_RTN firm_update_ver11(common::DB* db, TLV_HANDLE_DEV_FIRM_V11& firm_handle);
	...
	TLV_HANDLE_RTN warning_type_update_ver12(common::DB* db, const string& order_id, const string& ref_date, const int& position, const string& level);
	TLV_HANDLE_RTN th_update(common::DB* db, TLV_HANDLE_TH& th_handle);
	TLV_HANDLE_RTN th_update_ver12(common::DB* db, TLV_HANDLE_TH& th_handle);
	...
	TLV_HANDLE_RTN dev_type_update(common::DB* db, TLV_HANDLE_DEV_TYPE& dev_type_handle);
	...
	TLV_HANDLE_RTN th2_update_ver12(common::DB* db, TLV_HANDLE_TH2& th_handle);
