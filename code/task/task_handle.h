...
public:
	...
	session::HANDLE_RTN cidTimeStart(const protocol::PacketIn* in, protocol::PacketOut* out);
	session::HANDLE_RTN cidTimeEnd(const protocol::PacketIn* in, protocol::PacketOut* out);
	session::HANDLE_RTN cidDevbandTime(const protocol::PacketIn* in, protocol::PacketOut* out);
	session::HANDLE_RTN cidDevType(const protocol::PacketIn* in, protocol::PacketOut* out);
	session::HANDLE_RTN cidSrvStatus(const protocol::PacketIn* in, protocol::PacketOut* out);
public:
	session::HANDLE_RTN cidAutoUploadR(const protocol::PacketIn* in, protocol::PacketOut* out);
public:
	...
	session::HANDLE_RTN sendStartTime(const protocol::PacketIn* in, protocol::PacketOut* out);
	session::HANDLE_RTN sendEndTime(const protocol::PacketIn* in, protocol::PacketOut* out);
};
