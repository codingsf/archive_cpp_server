...
namespace common
{
	...
	bool PyCall::py_requestAmapUseAddr(string& request, string& address)
	{
		...
		if(!rtn)
		{
			LOG_DEBUG("python : call function requestAmapUseAddr fail!");
			return false;
		}
	...
	bool PyCall::py_notifyJava(string& request, string& result)
	{
		...
		if(!rtn)
		{
			LOG_DEBUG("python : call function notifyJava fail!");
			return false;
		}
	...
	bool PyCall::py_notifyJavaEnhance(string& request, string& result, string& code)
	{
		...
		if(!rtn)
		{
			LOG_DEBUG("python : call function notifyJavaEnhance fail!");
			return false;
		}
