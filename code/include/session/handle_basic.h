...
namespace session
{
	...
	public:
		...
		virtual HANDLE_RTN cidTimeStart(const protocol::PacketIn* in, protocol::PacketOut* out);
		virtual HANDLE_RTN cidTimeEnd(const protocol::PacketIn* in, protocol::PacketOut* out);
		virtual HANDLE_RTN cidDevbandTime(const protocol::PacketIn* in, protocol::PacketOut* out);
		virtual HANDLE_RTN cidDevType(const protocol::PacketIn* in, protocol::PacketOut* out);
		virtual HANDLE_RTN cidSrvStatus(const protocol::PacketIn* in, protocol::PacketOut* out);
	public:
		virtual HANDLE_RTN cidJztDev(const protocol::PacketIn* in, protocol::PacketOut* out);
		virtual HANDLE_RTN cidJztLbs(const protocol::PacketIn* in, protocol::PacketOut* out);
		virtual HANDLE_RTN cidJztTh2(const protocol::PacketIn* in, protocol::PacketOut* out);
	public:
		virtual HANDLE_RTN cidAutoUploadR(const protocol::PacketIn* in, protocol::PacketOut* out);
	public:
		//分发 RFID 消息
